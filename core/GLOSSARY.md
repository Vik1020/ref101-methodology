...
Полный словарь терминов, аббревиатур и domain-specific концепций, используемых в документации specifications/.
...
**См. также:** [EPA_CHECKLIST.md](reference/assets/EPA_CHECKLIST.md)
...
**См. также:** guides/standards/testing/CONTEXT_HEALTH_METRICS.md
...
**Процесс:** Migration guide обязателен (см. MIGRATION_STRATEGY.md)
...
- [SYSTEM_PROMPT.md](SYSTEM_PROMPT.md) - Главная инструкция
- [01_PHILOSOPHY.md](architecture/01_PHILOSOPHY.md) - Vibe Coding философия
...
**Не нашли термин?**
Создайте issue или добавьте его в этот глоссарий напрямую через PR.
